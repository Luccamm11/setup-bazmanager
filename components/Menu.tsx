...
const Menu: React.FC<MenuProps> = ({ onNavigate, userRole }) => {
  ...
  const menuItems: { view: View; label: string; desc: string; icon: React.ElementType; techOnly?: boolean; highlight?: boolean }[] = [
    ...
    { view: 'mentor_management', label: 'Mentores & Voluntários', desc: 'Cadastre mentores/voluntários e registre sessões de mentoria ou trabalhos voluntários', icon: GraduationCap },
    ...(userRole === 'technician' ? [
